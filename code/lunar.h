...
public:
    Lunar();
    QString getLunar(int year, int month, int day);
    QString getLunar(QString year, QString month, QString day);
    int weekOfDate(int year, int month, int day);
    int weekOfDate(QString year, QString month, QString day);
private:
